...
int main()
{
    Model model;
    Graph<float> graph;
    fstream input("/home/liulei/work/BERTCpp/model/model.proto", ios::in | ios::binary);
    ...
    FullTokenizer tokenizer("/home/liulei/work/BERTCpp/model/bert-base-uncased-vocab.txt");
